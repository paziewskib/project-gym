...
<head>
	...
	<title>ZaÅ‚Ã³Å¼ darmowe konto!</title>
</head>
<body>
...
<form action="registerlogic.php" method="post">
	...
	<label class="radio-inline"><input id="inlineRadio2" class="radio-inline" type="radio" name="gender" value="male">MÄ™Å¼czyzna</label><br>
	<?php
	 ...
	 ?>
	<input type="submit" class="btn btn-primary" value="ZaÅ‚Ã³Å¼ konto" style="margin-top: 10px;">
    </div>
</form>
    <div>
</div>
